...
class LocalEnvironment(Environment):
	...
	def step(self, action):
		...
		print("SGenerator Kw/h 153 Before: ",net.sgen.p_kw.loc[153])
		net.sgen.p_kw.loc[153]=wind_power*csv_data_wind.wind[self.step_made%5]
		print("SGenerator Kw/h 153 After: ",net.sgen.p_kw.loc[153])
		...
		reward_obj = rw.__dict__[self.reward_id](state[0:3], self.last_state, self.last_reward, self.reward_keys)#state slice to control the amount of input faktors
